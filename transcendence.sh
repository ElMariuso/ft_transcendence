...
case $2 in
    ...
    restart)
        ...
        ;;
    clean-volumes)
        rm -rf database logs-front logs-back uploads frontend-live ./frontend/.next ./frontend/node_modules ./frontend/next-env.d.ts ./backend/uploads ./backend/dist ./backend/logs ./backend/node_modules
        ;;
    remove-volumes)
